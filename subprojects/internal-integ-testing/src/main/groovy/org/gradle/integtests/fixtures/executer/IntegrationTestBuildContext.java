...
public class IntegrationTestBuildContext {
    ...
    public TestFile getAllDistribution() {
        return nullableFile("integTest.allDistribution", null);
    }

    @Nullable
    public TestFile getDocsDistribution() {
        return nullableFile("integTest.docsDistribution", null);
    }

    @Nullable
    public TestFile getSrcDistribution() {
        return nullableFile("integTest.srcDistribution", null);
    }
