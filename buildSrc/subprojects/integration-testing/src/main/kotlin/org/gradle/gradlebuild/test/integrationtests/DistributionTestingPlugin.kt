...
class DistributionTestingPlugin : Plugin<Project> {
    ...
    fun DistributionTest.configureGradleTestEnvironment(layout: ProjectLayout, configurations: ConfigurationContainer) {
        ...
        binDistributionZip.distributionZip.setFrom(configurations["${prefix}BinDistributionPath"])
        allDistributionZip.distributionZip.setFrom(configurations["${prefix}AllDistributionPath"])
        docsDistributionZip.distributionZip.setFrom(configurations["${prefix}DocsDistributionPath"])
        srcDistributionZip.distributionZip.setFrom(configurations["${prefix}SrcDistributionPath"])
    }
